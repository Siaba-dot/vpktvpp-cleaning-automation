# app_vpk.py – VPK/TVPP: Grafikas → X (Pn–Pn) → Periodiškumas → Kaina (TRUNC)
# -*- coding: utf-8 -*-
import io
import re
import calendar
...
# =========================
st.set_page_config(
    page_title="VPK/TVPP: Grafikas → Aktas (X, Periodiškumas, Kaina – TRUNC)",
    page_icon="🧾",
    layout="wide",
)
...
st.title("🧾 VPK/TVPP: Grafikas → X (Pn–Pn) → Periodiškumas → Kaina (TRUNC)")
...
# FIKSUOTI MĖNESIŲ DIAPAZONAI (Anykščių tipo grafikas)
FIXED_GRID_RANGES: Dict[int, str] = {
    11: "C7:G38",
    12: "H7:L38", 1: "H7:L38", 2: "H7:L38",
    3:  "M7:Q38",
    4:  "R7:V38",
    5:  "W7:AA38",
    6:  "AB7:AF38", 7: "AB7:AF38", 8: "AB7:AF38", 9: "AB7:AF38", 10: "AB7:AF38"
}
...
with st.sidebar:
    ...
    read_mode = st.radio("Grafiko skaitymo režimas", ["Fiksuoti diapazonai (ABCD tipo)", "Autodetekcija"], index=0)
